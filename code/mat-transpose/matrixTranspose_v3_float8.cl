__kernel void matrixTranspose(const int heightA,
    ...
    __global float *src_a_4 = a + (rowA+4) * widthA + (colA+0);
    __global float *src_a_5 = a + (rowA+5) * widthA + (colA+0);
    __global float *src_a_6 = a + (rowA+6) * widthA + (colA+0);
    __global float *src_a_7 = a + (rowA+7) * widthA + (colA+0);
     
    float8 vec1x8_0 = *((__global float8 *)src_a_0);
    float8 vec1x8_1 = *((__global float8 *)src_a_1);
    float8 vec1x8_2 = *((__global float8 *)src_a_2);
    float8 vec1x8_3 = *((__global float8 *)src_a_3);

    float8 vec1x8_4 = *((__global float8 *)src_a_4);
    float8 vec1x8_5 = *((__global float8 *)src_a_5);
    float8 vec1x8_6 = *((__global float8 *)src_a_6);
    float8 vec1x8_7 = *((__global float8 *)src_a_7);

		a_T[(colA+0) * heightA + (rowA+0)] = vec1x8_0.x;
		a_T[(colA+1) * heightA + (rowA+0)] = vec1x8_0.y;
   	a_T[(colA+2) * heightA + (rowA+0)] = vec1x8_0.z;
    a_T[(colA+3) * heightA + (rowA+0)] = vec1x8_0.w;
