__kernel void matrixTranspose(const int heightA,
    ...
    float4 *vec1x4_0 = (__global float4 *)src_a_0;
    float4 *vec1x4_1 = (__global float4 *)src_a_1;
    float4 *vec1x4_2 = (__global float4 *)src_a_2;
    float4 *vec1x4_3 = (__global float4 *)src_a_3;
